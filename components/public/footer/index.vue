    ...
    <div class="wrap">
      <div class="copy">
        <p class="link" id="music-link">
          ...
          <a href="//music.163.com/html/web2/privacy.html" target="_blank" class="item s-fc4">隐私政策</a><span class="line">|</span>
        ...
        <p class="right s-fc3">
          <span class="sep span">网易公司版权所有©1997-2019</span><span class="span">杭州乐读科技有限公司运营：</span><a href="http://p1.music.126.net/03WF0APmm-J0TqdbOc8-XQ==/109951163649544962.png" target="_blank" class="alink s-fc3">浙网文[2018]3506-263号</a>
        </p>
      ...
      <ul class="enter">
        <li class="unit">
          <a class=" "><i class="el-icon-mic"></i></a>
          <span class="tt">视频奖赏</span>
        </li>
        <li class="unit">
          <a class=" "><i class="el-icon-service"></i></a>
          <span class="tt">赞赏</span>
        </li>
        <li class="unit">
          <a class=" "><i class="el-icon-headset"></i></a>
          <span class="tt">独立音乐人</span>
        </li>
        <li class="unit">
          <a class=" "><i class="el-icon-school"></i></a>
